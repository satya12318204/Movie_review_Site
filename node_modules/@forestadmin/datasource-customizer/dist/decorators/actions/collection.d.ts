import { ActionField, ActionResult, Caller, CollectionDecorator, CollectionSchema, DataSourceDecorator, Filter, GetFormMetas, RecordData } from '@forestadmin/datasource-toolkit';
...
export default class ActionCollectionDecorator extends CollectionDecorator {
    ...
    private evaluate;
    private isHandler;
    private isSearchOptionsHandler;
}

...
export type ColumnSchemaValidation = Array<{
    operator: Operator;
    value?: unknown;
}>;
...
export type ColumnType = PrimitiveTypes | {
    [key: string]: ColumnType;
} | [ColumnType];
export type PrimitiveTypes = 'Boolean' | 'Binary' | 'Date' | 'Dateonly' | 'Enum' | 'Json' | 'Number' | 'Point' | 'String' | 'Time' | 'Timeonly' | 'Uuid';
